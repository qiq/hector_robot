...
inline char *Fetch::GetPropertySync(const char *name) {
	return props->GetProperty(name);
}

inline bool Fetch::SetPropertySync(const char *name, const char *value) {
	return props->SetProperty(name, value);
}

inline std::vector<std::string> *Fetch::ListPropertiesSync() {
