...
Fetch::Fetch(ObjectRegistry *objects, const char *id, int threadIndex): Module(objects, id, threadIndex) {
	...
	props = new ObjectProperties<Fetch>(this);
	props->Add("items", &Fetch::GetItems);
	props->Add("minServerRelax", &Fetch::GetMinServerRelax, &Fetch::SetMinServerRelax);
	props->Add("timeout", &Fetch::GetTimeout, &Fetch::SetTimeout);
	props->Add("from", &Fetch::GetFrom, &Fetch::SetFrom, true);
	props->Add("userAgent", &Fetch::GetUserAgent, &Fetch::SetUserAgent, true);
	props->Add("maxRequests", &Fetch::GetMaxRequests, &Fetch::SetMaxRequests, true);
	props->Add("maxContentLength", &Fetch::GetMaxContentLength, &Fetch::SetMaxContentLength);
	props->Add("timeTick", &Fetch::GetTimeTick, &Fetch::SetTimeTick);
	props->Add("allowedContentTypes", &Fetch::GetAllowedContentTypes, &Fetch::SetAllowedContentTypes);
...
char *Fetch::GetAllowedContentTypes(const char *name) {
	string result;
...
void Fetch::SetAllowedContentTypes(const char *name, const char *value) {
...
void Fetch::QueueResource(PageResource *pr) {
...
void Fetch::StartResourceFetch(PageResource *pr, int index) {
	// set URL
...
bool Fetch::CheckContentType(string *contentType) {
	bool allowed = false;
...
bool Fetch::ProcessMultiSync(queue<Resource*> *inputResources, queue<Resource*> *outputResources, int *expectingResources, int *processingResources) {
