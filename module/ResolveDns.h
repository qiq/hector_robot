...
private:
	...
	ObjectProperties<ResolveDns> *props;
...
inline char *ResolveDns::GetPropertySync(const char *name) {
	return props->GetProperty(name);
}

inline bool ResolveDns::SetPropertySync(const char *name, const char *value) {
	return props->SetProperty(name, value);
}

inline std::vector<std::string> *ResolveDns::ListPropertiesSync() {
